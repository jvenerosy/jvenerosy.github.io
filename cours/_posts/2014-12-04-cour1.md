...
img : http://placehold.it/300x200/92bfbf/ffffff&amp;text=Introduction+au+web
---
{::options parse_block_html="true" /}
<div>
##Cours n°1 : Découverte du web (~2h)

- [Pré-requis](#pr-requis)
- [Comprendre comment est fait un site internet](#quelques-aides)
- [Installation des premiers outils](#les-premiers-outils)
- [Création d'un mini-site local](#notre-premier-site)
- [Devoirs pour la semaine prochaine](#devoirs-pour-la-semaine-prochaine)
</div>
{:.sommaire}
<div>
##pré-requis
...
Une balise html (langage que nous utilisons) se présente sous plusieurs formes :
 ...
 - Liste exhaustive de balise HTML : https://developer.mozilla.org/fr/docs/Web/HTML/Element
